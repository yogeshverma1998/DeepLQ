...
weight_arr = np.concatenate((sigma2,sigma3,sigma4,sigma5,sigma6,sigma7,sigma8,sigma1,wst1,wst2,wst3,wst4,wdy,www,wwz,wzz),axis=0)
...
#Model Training
print("##############  TRAINING BINARY CLASSIFICATION MODEL WITH PHYSICAL EVENT WEIGHTS  ###############")
LQ_model = base_model()
...
f1 = open("/work/yverma/DNN_SLQ/LQ500_binary_wet.txt", "w+")
...
f2 = open("/work/yverma/DNN_SLQ/LQ800_binary_wet.txt", "w+")
...
f3 = open("/work/yverma/DNN_SLQ/LQ1100_binary_wet.txt", "w+")
...
f4 = open("/work/yverma/DNN_SLQ/LQ1400_binary_wet.txt", "w+")
...
f5 = open("/work/yverma/DNN_SLQ/LQ1700_binary_wet.txt", "w+")
...
f6 = open("/work/yverma/DNN_SLQ/LQ2000_binary_wet.txt", "w+")
...
f7 = open("/work/yverma/DNN_SLQ/LQ2300_binary_wet.txt", "w+")
...
f8 = open("/work/yverma/DNN_SLQ/TT_binary_wet.txt", "w+")
...
f9 = open("/work/yverma/DNN_SLQ/ST1_binary_wet.txt", "w+")
...
f10 = open("/work/yverma/DNN_SLQ/ST2_binary_wet.txt", "w+")
...
f11 = open("/work/yverma/DNN_SLQ/ST3_binary_wet.txt", "w+")
...
f12 = open("/work/yverma/DNN_SLQ/ST4_binary_wet.txt", "w+")
...
f13 = open("/work/yverma/DNN_SLQ/DY_binary_wet.txt", "w+")
...
f14 = open("/work/yverma/DNN_SLQ/WW_binary_wet.txt", "w+")
...
f15 = open("/work/yverma/DNN_SLQ/WZ_binary_wet.txt", "w+")
...
f16 = open("/work/yverma/DNN_SLQ/ZZ_binary_wet.txt", "w+")
