...
#weights used to scale the histogram
...
#Reading text output files from DNN

with open("/work/yverma/DNN_SLQ/ZZ_mass.txt") as zz:
    ZZ_wt = [line.split() for line in zz]

with open("/work/yverma/DNN_SLQ/WW_mass.txt") as ww:
    WW_wt = [line.split() for line in ww]

with open("/work/yverma/DNN_SLQ/WZ_mass.txt") as wz:
    WZ_wt = [line.split() for line in wz]

with open("/work/yverma/DNN_SLQ/DY_mass.txt") as dy:
    DY_wt = [line.split() for line in dy]

with open("/work/yverma/DNN_SLQ/ST1_mass.txt") as st1:
    ST1_wt = [line.split() for line in st1]

with open("/work/yverma/DNN_SLQ/ST2_mass.txt") as st2:
    ST2_wt = [line.split() for line in st2]

with open("/work/yverma/DNN_SLQ/ST3_mass.txt") as st3:
    ST3_wt = [line.split() for line in st3]

with open("/work/yverma/DNN_SLQ/ST4_mass.txt") as st4:
    ST4_wt = [line.split() for line in st4]

with open("/work/yverma/DNN_SLQ/TT_mass.txt") as tt:
    TT_wt = [line.split() for line in tt]

with open("/work/yverma/DNN_SLQ/LQ500_mass.txt") as lq50:
    lQ50_wt = [line.split() for line in lq50]

with open("/work/yverma/DNN_SLQ/LQ800_mass.txt") as lq80:
    lQ80_wt = [line.split() for line in lq80]

with open("/work/yverma/DNN_SLQ/LQ1100_mass.txt") as lq110:
    lQ110_wt = [line.split() for line in lq110]

with open("/work/yverma/DNN_SLQ/LQ1400_mass.txt") as lq140:
    lQ140_wt = [line.split() for line in lq140]

with open("/work/yverma/DNN_SLQ/LQ1700_mass.txt") as lq170:
    lQ170_wt = [line.split() for line in lq170]

with open("/work/yverma/DNN_SLQ/LQ2000_mass.txt") as lq200:
    lQ200_wt = [line.split() for line in lq200]

with open("/work/yverma/DNN_SLQ/LQ2300_mass.txt") as lq230:
...
hist = ROOT.TH1F("plot1","",300,0,2400)
for i in DY_arr_wt:
...
hist0 = ROOT.TH1F("plot0","",300,0,2400)
for i in TT_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist0.Fill(i,sigma1)
...
hist2 = ROOT.TH1F("plot2","",300,0,2400)
...
hist3 = ROOT.TH1F("plot3","",300,0,2400)
...
hist4 = ROOT.TH1F("plot4","",300,0,2400)
...
hist5 = ROOT.TH1F("plot5","",300,0,2400)
...
hist6 = ROOT.TH1F("plot6","",300,0,2400)
...
hist7 = ROOT.TH1F("plot7","",300,0,2400)
...
hist8 = ROOT.TH1F("plot8","",300,0,2400)
...
hist_st1 = ROOT.TH1F("plotst1","",300,0,2400)
for i in ST1_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_st1.Fill(i)
...
hist_st2 = ROOT.TH1F("plotst2","",300,0,2400)
for i in ST2_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_st2.Fill(i)
...
hist_st3 = ROOT.TH1F("plotst3","",300,0,2400)
for i in ST3_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_st3.Fill(i)
...
hist_st4 = ROOT.TH1F("plotst4","",300,0,2400)
for i in ST4_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_st4.Fill(i)
...
hist_ww = ROOT.TH1F("plotww","",300,0,2400)
for i in WW_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_ww.Fill(i)
...
hist_zz = ROOT.TH1F("plotzz","",300,0,2400)
for i in ZZ_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_zz.Fill(i)
...
hist_wz = ROOT.TH1F("plotwz","",300,0,2400)
for i in WZ_arr_wt:
    ROOT.gStyle.SetOptStat(0)
    hist_wz.Fill(i)
...
hist_fn = ROOT.TH1F("plotfn","",300,0,2400)
...
hist_fn.Draw("Same")
hist_db = ROOT.TH1F("plotdb","",300,0,2400)
...
legend.Draw()
c1.Print("/work/yverma/DNN_SLQ/Mass_Reconst.png")
